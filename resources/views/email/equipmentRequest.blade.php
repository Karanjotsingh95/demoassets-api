		...
		<div style="padding:50px;background:#fafafa">
				...
				<div style="font-color:#112f6f;font-size:18px;font-family: 'Helvetica', 'Arial', sans-serif;">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>{!! $customMessage['table'][asset_title] !!}</td>
                                <td>{!! $customMessage['message']['mn_number'] !!}</td>
                                <td>{!! $customMessage['message']['deliver_by'] !!}</td>
                                <td>{!! $customMessage['message']['receiver'] !!}</td>
                                <td>{!! $customMessage['message']['end_date'] !!}</td>
                            </tr>
                        </tbody>
                    </table>
                    @endif()
